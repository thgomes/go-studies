...
type CategoryServiceClient interface {
	...
	GetCategories(ctx context.Context, in *CategoryGetRequest, opts ...grpc.CallOption) (*Category, error)
...
func (c *categoryServiceClient) GetCategories(ctx context.Context, in *CategoryGetRequest, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	GetCategories(context.Context, *CategoryGetRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) GetCategories(context.Context, *CategoryGetRequest) (*Category, error) {
...
func _CategoryService_GetCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategories(ctx, req.(*CategoryGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
